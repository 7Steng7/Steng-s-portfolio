  ...
  return (
    <>
      <section className="flex flex-col justify-center items-center bg-darkSeaGreen rounded-lg md:items-start md:pl-16 md:items-start lg:pl-0 lg:flex-row lg:items-center lg:pl-16">
        ...
        <h1 className='text-center font-bold text-3xl mb-6 md:text-right' style={{width : '90%'}}>🧭 Con dirección clara, cada objetivo se convierte en destino.</h1>
          <p className="text-center w-60 mb-6 text-lg p-4 md:text-right md:mb-0" style={{width : '90%'}}>
